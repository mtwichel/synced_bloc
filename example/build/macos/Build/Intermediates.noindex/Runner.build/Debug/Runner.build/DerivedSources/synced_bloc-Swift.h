...
#ifndef SYNCED_BLOC_SWIFT_H
#define SYNCED_BLOC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="synced_bloc",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC11synced_bloc11AppDelegate")
...
SWIFT_CLASS("_TtC11synced_bloc17MainFlutterWindow")
